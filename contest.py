...
opener.addheaders.append(("Cookie",
                          "Session_id=3:1453190014.5.0.1452858600974:olfVsA:4f.0|116308269.0.2|140091.142040.4QkOQqVmExBr7_lIKJw_zT4vdiI"))  # Paste your Session_id from Yandex.Contest after authorization here

with io.open("table.csv", "w", newline="", encoding='utf8') as csvfile:  # It will write results in csv file
